...
public class Ball extends BallPrototype {
     ...
     */
    public Ball clone() {
        return new Ball(this.colourString, this.xPosition , this.yPosition, this.xVelocity, this.yVelocity, this.mass,
            this.isCue, this.strategy);
    }
    ...
    /**
     * Sets isActive status of ball.
     * 
     * @param active status of ball.
     */
